...
H4: { 
  ...
  HUR: {
    name: "Hürtgen Forest",
    image: "images/maps/map_hurtgen.webp",
    ...
    strongpoints: [
      ...
      // --- ALLIES SECTORS ---
      { label: "LUMBER YARD", id: "B1", gameX: -77356.0, gameY: -36029.0, radius: 4000.0, team: "us", type: "strongpoint" },
      { label: "RESERVE STATION", id: "B2", gameX: -78776.0, gameY: -2238.0, radius: 4500.0, team: "us", type: "strongpoint" },
      { label: "MAUSBACH APPROACH", id: "B3", gameX: -74423.0, gameY: 46733.0, radius: 4625.0, team: "us", type: "strongpoint" },
      { label: "THE RUIN", id: "B4", gameX: -42793.0, gameY: -26141.0, radius: 4400.0, team: "us", type: "strongpoint" },
      { label: "KALL TRAIL", id: "B5", gameX: -35755.0, gameY: -2459.0, radius: 6000.0, team: "us", type: "strongpoint" },
      { label: "WEHEBACH OVERLOOK", id: "B6", gameX: -38278.0, gameY: 34416.0, radius: 5031.25, team: "us", type: "strongpoint" },

      // --- NEUTRAL SECTORS ---
      { label: "THE SIEGFRIED LINE", id: "B7", gameX: -3711.0, gameY: -42305.0, radius: 4500.0, team: "neu", type: "strongpoint" },
      { label: "THE SCAR", id: "B8", gameX: -6935.0, gameY: -3328.0, radius: 3015.0, team: "neu", type: "strongpoint" },
      { label: "NORTH PASS", id: "B9", gameX: 6540.0, gameY: 49329.0, radius: 4347.0, team: "neu", type: "strongpoint" },

      // --- AXIS SECTORS ---
      { label: "SALIENT 42", id: "B10", gameX: 40632.0, gameY: -50244.0, radius: 3250.0, team: "ger", type: "strongpoint" },
      { label: "JACOB'S BARN", id: "B11", gameX: 37658.0, gameY: -8531.0, radius: 3500.0, team: "ger", type: "strongpoint" },
      { label: "HILL 15", id: "B12", gameX: 45628.0, gameY: 34330.0, radius: 4500.0, team: "ger", type: "strongpoint" },
      { label: "LOGGING CAMP", id: "B13", gameX: 64477.0, gameY: -51502.0, radius: 3750.0, team: "ger", type: "strongpoint" },
      { label: "HURTGEN APPROACH", id: "B14", gameX: 67776.0, gameY: -6558.0, radius: 3500.0, team: "ger", type: "strongpoint" },
      { label: "GROSSHAU APPROACH", id: "B15", gameX: 73663.0, gameY: 38895.0, radius: 3750.0, team: "ger", type: "strongpoint" }
    ]
  },
...
KUR: { 
    ...
    strongpoints: [
      ...
      { label: "GARRISON POSITION", id: "B5", gameX: -35117.0, gameY: 68921.0, radius: 6000.0, team: "us", type: "strongpoint" },
  ...
  OMA: { 
    ...
    strongpoints: [
      ...
      { label: "GARRISON BATTERY", id: "B7", gameX: 2342.277, gameY: -31510.633, radius: 5000.0, team: "neu", type: "strongpoint" },
...
PHL: { 
    ...
    strongpoints: [
      ...
      { label: "JOURDAN CANAL", id: "B14", gameX: -41489.133, gameY: 38108.99, radius: 2750.0, team: "ger", type: "strongpoint" },
      { label: "DOUVE BRIDGE", id: "B5", gameX: -1434.0474, gameY: 26826.268, radius: 4250.0, team: "us", type: "strongpoint" },
      { label: "DOUVE RIVER BATTERY", id: "B15", gameX: 33572.38, gameY: 36601.72, radius: 3500.0, team: "ger", type: "strongpoint" },
      
      // --- NEUTRAL SECTORS ---
      { label: "GROULT PILLBOX", id: "B7", gameX: -37607.4, gameY: 5672.991, radius: 5500.0, team: "neu", type: "strongpoint" },
      ...
      { label: "INGOUF CROSSROADS", id: "B9", gameX: -36344.676, gameY: -66489.59, radius: 3250.0, team: "neu", type: "strongpoint" },
      { label: "ROAD TO CARENTAN", id: "B2", gameX: 2953.2188, gameY: -63908.098, radius: 3000.0, team: "us", type: "strongpoint" },
      { label: "CABBAGE PATCH", id: "B4", gameX: 46253.22, gameY: -62363.098, radius: 2500.0, team: "ger", type: "strongpoint" }
    ] 
  },
...
SMM: { 
    ...
    strongpoints: [
      ...
      // --- ALLIES SECTORS ---
      { label: "WINTERS LANDING", id: "B2", gameX: -39503.26, gameY: 78343.03, radius: 5755.0, team: "us", type: "strongpoint" },
      { label: "LE GRAND CHEMIN", id: "B3", gameX: -367.0, gameY: 76667.0, radius: 4500.0, team: "us", type: "strongpoint" },
      { label: "THE BARN", id: "B4", gameX: 44896.0, gameY: 73822.0, radius: 5691.0, team: "us", type: "strongpoint" },
      { label: "BRECOURT BATTERY", id: "B1", gameX: -39380.0, gameY: 39702.0, radius: 6079.0, team: "us", type: "strongpoint" },
      { label: "CATTLESHEDS", id: "B11", gameX: 2961.32, gameY: 41557.40, radius: 5401.0, team: "us", type: "strongpoint" },
      { label: "RUE DE LA GARE", id: "B12", gameX: 35565.56, gameY: 39370.59, radius: 5893.0, team: "us", type: "strongpoint" },

      // --- NEUTRAL SECTORS ---
      { label: "THE DUGOUT", id: "B13", gameX: -37170.91, gameY: 151.19, radius: 5815.0, team: "neu", type: "strongpoint" },
      { label: "AA NETWORK", id: "B5", gameX: 1716.0, gameY: -2530.0, radius: 6531.0, team: "neu", type: "strongpoint" },
      { label: "PIERRE'S FARM", id: "B6", gameX: 37508.1, gameY: -1336.70, radius: 5207.0, team: "neu", type: "strongpoint" },

      // --- AXIS SECTORS ---
      { label: "HUGO'S FARM", id: "B10", gameX: -38001.0, gameY: -38089.0, radius: 6046.0, team: "ger", type: "strongpoint" },
      { label: "THE HAMLET", id: "B15", gameX: -2158.77, gameY: -42649.31, radius: 4500.0, team: "ger", type: "strongpoint" },
      { label: "STE MARIE DU MONT", id: "B14", gameX: 47022.13, gameY: -50258.56, radius: 6000.0, team: "ger", type: "strongpoint" },
      { label: "THE CORNER", id: "B9", gameX: -34620.76, gameY: -69152.77, radius: 5106.0, team: "ger", type: "strongpoint" },
      { label: "HILL 6", id: "B8", gameX: 142.14, gameY: -76822.93, radius: 4500.0, team: "ger", type: "strongpoint" },
      { label: "THE FIELDS", id: "B7", gameX: 39750.15, gameY: -78234.78, radius: 4500.0, team: "ger", type: "strongpoint" }
    ] 
  },
...
UTA: { 
    ...
    strongpoints: [
      ...
      // --- ALLIES SECTORS ---
      { label: "WN5", id: "B8", gameX: 48763.0, gameY: -44080.0, radius: 3194.0, team: "us", type: "strongpoint" },
      { label: "HILL 5", id: "B7", gameX: 36131.0, gameY: 1838.0, radius: 3000.0, team: "us", type: "strongpoint" },
      { label: "AA BATTERY", id: "B18", gameX: 35101.0, gameY: 43589.0, radius: 3942.0, team: "us", type: "strongpoint" },
      { label: "UNCLE RED", id: "B5", gameX: 66675.0, gameY: -45162.0, radius: 2824.0, team: "us", type: "strongpoint" },
      { label: "RED ROOF HOUSE", id: "B4", gameX: 64923.67, gameY: -3144.0, radius: 3250.0, team: "us", type: "strongpoint" },
      { label: "TARE GREEN", id: "B3", gameX: 63845.0, gameY: 46581.0, radius: 3000.0, team: "us", type: "strongpoint" },

      // --- NEUTRAL SECTORS ---
      { label: "WN7", id: "B9", gameX: 727.0, gameY: -50408.0, radius: 5000.0, team: "neu", type: "strongpoint" },
      { label: "THE CHAPEL", id: "B10", gameX: 10650.0, gameY: 7786.0, radius: 3000.0, team: "neu", type: "strongpoint" },
      { label: "WN4", id: "B11", gameX: 5359.0, gameY: 42267.0, radius: 3742.0, team: "neu", type: "strongpoint" },

      // --- AXIS SECTORS ---
      { label: "SAINTE MARIE APPROACH", id: "B17", gameX: -64837.0, gameY: -52705.0, radius: 3000.0, team: "ger", type: "strongpoint" },
      { label: "FLOODED HOUSE", id: "B16", gameX: -66464.0, gameY: 2944.0, radius: 3000.0, team: "ger", type: "strongpoint" },
      { label: "MAMMUT RADAR", id: "B15", gameX: -65158.0, gameY: 51522.0, radius: 3000.0, team: "ger", type: "strongpoint" },
      { label: "DROWNED FIELDS", id: "B13", gameX: -36400.0, gameY: -43928.0, radius: 3000.0, team: "ger", type: "strongpoint" },
      { label: "LA GRANDE CRIQUE", id: "B12", gameX: -28986.0, gameY: -508.0, radius: 3294.0, team: "ger", type: "strongpoint" },
      { label: "SUNKEN BRIDGE", id: "B14", gameX: -30810.0, gameY: 47853.0, radius: 3000.0, team: "ger", type: "strongpoint" }
    ] 
  },
};